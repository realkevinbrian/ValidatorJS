...
function validateChar(args){
    ...
    if(charCount.length === 9){
        ...
        return "Muitos numeros";
    
    }
    else{
        return "Poucos Numeros";
    }
...
function nameValidator(args) {
    ...
    if (args === "") {
        ...
        return "Nao pode deixar nome Vazio!";
        
    } else if(check){
        
        return "O nome nao pode conteter chara. Especiais nem Numeros";
    }else {

        return "O nome esta correcto";
...
function validateTelephoneNumber(number) {
    ...
    if (!valChar) {
        ...
        return "Numero não pode conter nenhum caracter so Digitos";
    }
}
